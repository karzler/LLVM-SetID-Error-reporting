...
#define LLVM_CONFIGTIME "Tue Jul  1 16:11:58 PDT 2014"
...
/* Define if the openssl libcrypto library is enabled */
#define LLVM_ENABLE_OPENSSL 1

/* Define if RNG is enabled */
#define LLVM_ENABLE_RNG 1
